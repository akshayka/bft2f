...
exports.hook_capabilities = function (next, connection) {
    ...
    //no starttls w/o authentication
...
exports.hook_unrecognized_command = function (next, connection, params) {
    ...
    /* Generate Random token -J */
    try {
        //var token = require('crypto').randomBytes(32);
        connection.respond(220, "Go ahead.");
    } catch (ex) {
        // handle error
        // most likely, entropy sources are drained
        connection.loginfo("token generation error");
    }
    ...
    connection.client.upgrade(plugin.tls_opts, function (authorized, verifyError, cert, cipher) {
        ...
        connection.reset_transaction(function () {
            ...
            //compare cert -J
            //connection.client.cert ?== cert
            // if ( connection.notes.pub_key !== cert){
            //     connection.logerror(plugin, "Cert doesn't match : "+connection.notes.pub_key +cert);
            // }
